...
import * as bassSampler from '../tunes/bass_sampler'
import * as guitarSampler from '../tunes/guitar_sampler'
import * as keySampler from '../tunes/key_sampler'
import * as heavySampler from '../tunes/heavy_sampler'
...
export default class SynthContainer extends PureComponent {
  ...
  initInstruments = () => {
    ...
    const instruments = [
      ...
      bassSampler.instrument,
      guitarSampler.instrument,
      keySampler.instrument,
      heavySampler.instrument,
    ]
